...
let logicJS = (brd) => {
    ...
    var A = brd.create('point', [0, 0], {
        name: '태양', size: 4, color: 'blue', fixed: true,
    ...
    var B = brd.create('point', [
        ...
        {
            name: '지구', size: 4, color: 'blue', fixed: true,
            label: { visible: true, fontSize: 20, strokeColor: 'red', cssStyle: 'margin-left: -5px; margin-top: 45px;' }
        });
    ...
    var B1 = brd.create('intersection', [perp, C, 0], { name: 'B1', size: 4, color: 'black', fixed: true });
    // point B3 is the intersection of perp and C
    var B3 = brd.create('intersection', [perp, C, 1], { name: 'B3', size: 4, color: 'black', fixed: true });
    // point B0 is the intersection of AB and C 
    var B0 = brd.create('intersection', [AB, C, 0], { name: 'B0', size: 4, color: 'black', fixed: true });
    // point B2 is the intersection of AB and C
    var B2 = brd.create('intersection', [AB, C, 1], { name: 'B2', size: 4, color: 'black', fixed: true });
    ...
    var B4 = brd.create('intersection', [bisector, C, 0], { name: 'B4', size: 4, color: 'black', fixed: true });
    // point B5 is the intersection of bisector and C
    var B5 = brd.create('intersection', [bisector, C, 1], { name: 'B5', size: 4, color: 'black', fixed: true });
    ...
    var B6 = brd.create('intersection', [bisector2, C, 0], { name: 'B6', size: 4, color: 'black', fixed: true });
    // point B7 is the intersection of bisector and C
    var B7 = brd.create('intersection', [bisector2, C, 1], { name: 'B7', size: 4, color: 'black', fixed: true });
