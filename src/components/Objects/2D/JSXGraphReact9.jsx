...
let logicJS = (brd) => {
    ...
    var C = brd.create('point', [13, -3], { name: 'C', withLabel: true, visible: true, fillColor: 'blue', strokeColor: 'black', highlightStrokeColor: 'blue', highlightFillColor: 'blue', highlightStrokeWidth: 4, strokeWidth: 1, size: 0 });
    ...
    var g1 = brd.create('glider', [10, 10, e1], { name: 'C', withLabel: true, visible: true, fillColor: '#00FFFF', strokeColor: 'black', highlightStrokeColor: '#00FFFF', highlightFillColor: '#00FFFF', highlightStrokeWidth: 4, strokeWidth: 1, size: 5 });
    ...
    // var curve = brd.create('tracecurve', [g1, p2]);
    brd.unsuspendUpdate();
}
